...
http_archive(
    ...
    strip_prefix = "solsjo-pandoc-plantuml-filter-f09c8da",
    ...
    sha256 = "0df0e1fa470d8366d89d3831dd11fca87bc034ec75de47917e2ede28ed3aaf58",
    type = "zip",
)

http_archive(
    name = "bazel_pandoc",
    strip_prefix = "solsjo-bazel-pandoc-3163bae",
    url = "https://github.com/solsjo/bazel-pandoc/zipball/master",
    sha256 = "34c6ae7a4c5de3b555ed303a5f284e2416e34372338759b9c9cc7c57cac1873d",
    type = "zip",
)
